        ...
        <section id = "projects" className="pt-48 pb-48" >
          ...
          >
           ...
           <div className="flex justify-center mt-5">
            ...
            In my portfolio, you'll find a diverse collection of projects
             that showcase my passion for web development and design. These projects reflect my commitment to quality, 
             my ability to adapt to different challenges, and my dedication to creating user-focused, high-performance solutions."
            </p>
          </motion.div>
          {/* PROJECTS */}
