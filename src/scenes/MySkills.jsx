...
//   export default MySkills;import LineGradient from "../components/LineGradient";
...
const MySkills = ({ setSelectedPage }) => {
  ...
  const skillsList = [
    {
      ...
      skills: ["C/C++", "JavaScript ES6", "Python", "HTML5/CSS3"],
    },
    {
      category: "Libraries and Frameworks",
      skills: ["ReactJS/Redux", "NodeJS", "MongoDB", "MySQL"],
    },
    {
  ...
  const renderSkills = (category, skills) => (
    <div className="md:w-1/3 mt-10" key={category}>
      <p className="font-playfair font-semibold text-3xl mb-3">{category}</p>
    ...
    <section id="skills" className="pt-0 pb-24">
      ...
      <div className="md:flex md:justify-between mt-10 gap-32">
        {skillsList.map((skillCategory) =>
          renderSkills(skillCategory.category, skillCategory.skills)
        )}
      </div>
    </section>
  );
